...
<asp:Content ID="loginHeader" ContentPlaceHolderID="Header" runat="server">
    <%--<%: Html.ActionLink("New Account", "Register", "Account", null, new { data_icon = "info", data_rel = "back" }) %>--%>
    <%: Html.ActionLink("New Account", "Register", "Account", null, new { data_icon = "info" }) %>
    <h1>Log in</h1>
</asp:Content>
